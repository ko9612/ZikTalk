  ...
  ({ filterValue, onFilterChange, isDeleteMode, onDeleteToggle }) => (
    <div className="mx-auto mb-2 flex w-full max-w-5xl flex-row items-center justify-between gap-0">
      ...
      <button
        ...
        className={twMerge(
          "bg-zik-main/10 text-zik-main hover:bg-zik-main/20 flex h-10 w-10 min-w-10 items-center justify-center rounded-full border border-none shadow-none focus:outline-none focus:ring-0",
