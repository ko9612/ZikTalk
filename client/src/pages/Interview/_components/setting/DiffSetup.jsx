...
const levels = [
  ...
  },
  {
    label: "경력 4~7년",
    description:
      "경험이 쌓인 만큼 기술 선택의 이유, 협업 경험, 아키텍처 이해 등 심화된 질문이 포함됩니다. 문제를 어떻게 바라보고 풀어가는지에 대한 사고 방식도 중요하게 평가해요",
    stars: 3,
  },
  {
    label: "경력 7년 이상",
    description:
      "기술 리더 혹은 아키텍트로서의 시야를 기대합니다. 조직 내 기술 방향성, 리딩 경험, 시스템 설계 전반에 대한 인사이트를 중심으로 질문합니다",
    stars: 4,
  },
];
