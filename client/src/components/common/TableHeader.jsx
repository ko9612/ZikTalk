...
export const QuestionTableHeader = () => (
  <div className="mb-3 hidden grid-cols-12 items-center border-t-2 border-b-2 border-t-gray-500 border-b-gray-200 px-1 py-2 text-xs font-semibold tracking-wide text-zik-text sm:grid sm:px-2 sm:text-sm md:px-4 md:text-base">
...
export const ResultsTableHeader = () => (
  <div className="mb-3 hidden grid-cols-12 items-center border-t-2 border-b-2 border-t-gray-500 border-b-gray-200 px-4 py-2 text-sm font-semibold tracking-wide text-zik-text sm:grid">
 ...
 */
<<<<<<< Updated upstream:client/src/pages/myPage/_components/common/TableHeader.jsx
...
export const EmptyStateContainer = ({
  ...
  return (
    <div className="mt-8 flex flex-col items-center text-zik-text">
      <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
        {icon}
      </div>
      <span>{title}</span>
...
>>>>>>> Stashed changes:client/src/components/common/TableHeader.jsx
    </div>
    <span>{title}</span>
