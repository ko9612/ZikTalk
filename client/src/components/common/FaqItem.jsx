        ...
        <div className="flex items-baseline justify-between px-4 py-3 max-sm:relative">
          <div className="flex w-full flex-col items-baseline sm:flex-row sm:items-center sm:px-6 sm:py-4">
            <div className="flex items-center">
              ...
              {career && (
                <div
                  className={`mr-1 ml-6 w-24 rounded-full px-2 py-0.5 text-start text-xs font-bold whitespace-nowrap ${textColors.normal} sm:mr-1 sm:ml-6 sm:w-32 sm:px-2 sm:py-1 sm:text-base`}
                >
                  {career}
                </div>
              )}
            ...
            <div
              className={`mt-1 line-clamp-1 text-sm font-medium break-words overflow-ellipsis ${textColors.normal} transition-all duration-500 ease-in-out sm:mt-0 sm:ml-4 sm:text-base ${
